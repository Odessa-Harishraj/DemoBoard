        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DevLead = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dev = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BALead = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DemoDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DesignETA = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ETA = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DevETA = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ProjectId = table.Column<int>(type: "int", nullable: false),
